...
- **安全**: 若涉及自残风险，请温和提示寻求专业热线。`
  ...
  return (
    <div
      className={`flex flex-col h-screen max-w-2xl mx-auto shadow-2xl relative overflow-hidden ring-1 ring-slate-200 transition-all duration-[3000ms] ${getBackgroundClass()}`}
    >
      <div className="emotion-field">
        <div className="emotion-blob w-[400px] h-[400px] -top-20 -left-20 bg-[var(--blob-1)]"></div>
        <div
          className="emotion-blob w-[300px] h-[300px] bottom-0 -right-10 bg-[var(--blob-2)]"
      ...
      {errorMessage && (
        <div className="mx-4 mb-4 px-4 py-3 bg-rose-50/80 backdrop-blur-md text-rose-700 text-sm font-medium flex items-center justify-between rounded-xl border border-rose-100 shadow-sm animate-in fade-in slide-in-from-top-2">
          ...
          <button
            ...
            className="hover:bg-rose-100 rounded-full p-1 transition-colors flex-shrink-0"
          >
            <svg
              className="h-4 w-4"
              fill="none"
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            {status === SessionStatus.CONNECTED ? (
              <button
                ...
                className="w-full py-4 bg-rose-50/80 hover:bg-rose-100 text-rose-600 font-bold rounded-2xl border border-rose-200 transition-all flex items-center justify-center space-x-2 active:scale-95"
              >
